...
public class FirebaseAuthController {
    ...
    public ResponseEntity<Map<String, Object>> loginOauthGet() {
        Map<String, Object> metadata = Map.of(
            "issuer",
            serverUrlsConfig.getIssuerUrl(),
            "authorization_endpoint",
            serverUrlsConfig.getAuthorizationEndpoint(),
            "token_endpoint",
            serverUrlsConfig.getTokenEndpoint(),
    ...
    public ResponseEntity<AuthResponse> authenticateWithFirebase(
        ...
        try {
            ...
            FirebaseToken decodedToken = firebaseAuthService.verifyToken(
                request.getIdToken()
            );
    ...
    @ResponseBody
    public ResponseEntity<AuthResponse> createSession(
        @RequestBody AuthRequest request,
        HttpSession session
    ) {
        try {
    ...
    public ResponseEntity<Map<String, String>> getConfig() {
        Map<String, String> config = Map.of(
            "projectId",
            firebaseAuthService.getProjectId(),
            "apiKey",
            firebaseAuthService.getApiKey()
        );
